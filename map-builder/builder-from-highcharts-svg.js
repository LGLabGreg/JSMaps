...
$(function() {
  ...
  request.open("GET", "maps/yemen.svg");
  ...
  request.addEventListener("load", function(event) {
    ...
    for(var i = 0; i < len; i++) {
      ...
      xml = doc.parseFromString(path, "image/svg+xml");

      console.log('desc: ' + xml.getElementsByTagName("name"));

      //name = desc.getElementsByTagName("name");
      ...
      var obj = {
        ...
        "selectedColor": "#feb41c",
        "url": "http:freehtml5maps.com/",
        "text": "<h1>" + path.getAttribute('id') + "</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
