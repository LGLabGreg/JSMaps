window.JSMaps.maps.connecticut = {
	"config": {
		"mapWidth": 700.400,
		"mapHeight": 511.500,
		"displayAbbreviations": false,
		"defaultText": "<h1>Connecticut</h1><br /><p>Connecticut is a U.S. state in southern New England that has a mix of coastal cities and rural areas dotted with small towns. Mystic is famed for its Seaport museum filled with centuries-old ships, and the beluga whale exhibits at Mystic Aquarium. On Long Island Sound, the city of New Haven is known as the home of Yale University and its acclaimed Peabody Museum of Natural History.</p>"
	},
	"paths": [
		{
			"enable": true,
			...
			"url": "http://jsmaps.io/",
			"text": "<h1>Hartford</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>New Haven</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Windham</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Litchfield</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Fairfield</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Tolland</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Middlesex</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>New London</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>",
